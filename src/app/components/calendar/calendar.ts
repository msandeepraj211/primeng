...
isSelectable(day, month, year, otherMonth): boolean {
    ...
    if (this.minDate) {
         if (this.minDate.getFullYear() > year) {
             ...
             else if (this.minDate.getMonth() === month && this.currentView !== 'month') {
    ...
    if (this.maxDate) {
         if (this.maxDate.getFullYear() < year) {
             ...
             else if (this.maxDate.getMonth() === month && this.currentView !== 'month') {
    ...
    if (this.disabledDates && this.currentView !== 'month') {
       validDate = !this.isDateDisabled(day,month,year);
    }

    if (this.disabledDays && this.currentView !== 'month') {
